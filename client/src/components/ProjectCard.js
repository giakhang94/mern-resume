  ...
  return (
    ...
    >
      <div className="thumb_info group relative w-full h-full rounded-md">
        <div className ="text-sm text-gray-500 font-bold absolute top-1 bg-white rounded-md py-1 px-1 hidden group-hover:block">Xin chờ page load hơi lâu ạ (vì mình dùng host free)</div>
